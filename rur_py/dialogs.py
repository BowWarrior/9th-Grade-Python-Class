...
class DialogOuterWorldError(MyDialogs):
    """ Custom dialog with Kranz Error image """
    def __init__(self, excpt):
        MyDialogs.__init__(self, None, -1, _("Error"), excpt.mesg,
                              _("Stay in the Matrix"), images.KRANZ_ERROR_IMAGE)
...
class OuterWorldException(LogicException):
    pass
